  ...
  return (
    <div className="relative min-h-screen text-slate-200 font-sans selection:bg-purple-500/30 overflow-hidden">
      ...
      <main className="relative z-10 h-screen flex flex-col lg:flex-row">
        ...
        <section className="flex-1 h-[50vh] lg:h-auto lg:w-[60%] relative order-2 lg:order-1 border-t lg:border-t-0 lg:border-r border-white/5 bg-[#0f1115]/30 backdrop-blur-sm">
          <ActivePanel 
        ...
        <section className="flex-1 h-[50vh] lg:h-auto lg:w-[40%] bg-[#0f1115]/50 backdrop-blur-md order-1 lg:order-2">
